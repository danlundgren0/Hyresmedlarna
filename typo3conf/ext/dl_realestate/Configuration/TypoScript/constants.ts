...
plugin.tx_dlrealestate_ajaxrequest {
    view {
        # cat=plugin.tx_dlrealestate_ajaxrequest/file; type=string; label=Path to template root (FE)
        templateRootPath = EXT:dl_realestate/Resources/Private/Templates/
        # cat=plugin.tx_dlrealestate_ajaxrequest/file; type=string; label=Path to template partials (FE)
        partialRootPath = EXT:dl_realestate/Resources/Private/Partials/
        # cat=plugin.tx_dlrealestate_ajaxrequest/file; type=string; label=Path to template layouts (FE)
        layoutRootPath = EXT:dl_realestate/Resources/Private/Layouts/
    }
    persistence {
        # cat=plugin.tx_dlrealestate_ajaxrequest//a; type=string; label=Default storage PID
        storagePid =
    }
}
