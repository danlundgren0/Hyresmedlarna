...
class SearchestatesController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    {
        $arguments = \TYPO3\CMS\Core\Utility\GeneralUtility::_GP('tx_dlsearchestates_searchestates');
        if($arguments && $arguments['realestate'] && (int)$arguments['realestate']>0) {
            $realestate = $this->realestateRepository->findByUid((int)$arguments['realestate']);
