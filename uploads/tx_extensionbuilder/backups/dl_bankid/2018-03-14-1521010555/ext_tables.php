...
call_user_func(
    function()
    {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_dlbankid_domain_model_feusergroup', 'EXT:dl_bankid/Resources/Private/Language/locallang_csh_tx_dlbankid_domain_model_feusergroup.xlf');
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_dlbankid_domain_model_feusergroup');
