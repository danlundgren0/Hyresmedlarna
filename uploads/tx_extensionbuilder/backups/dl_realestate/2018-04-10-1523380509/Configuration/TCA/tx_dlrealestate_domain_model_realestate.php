...
return [
    'ctrl' => [
        ...
        'searchFields' => 'residential_area,rent_from,rent_to,no_of_rooms,rent,furnitured,handicap_adapted,elevator,animals_allowed,other,upload_images1,upload_images2,upload_images3,upload_images4,upload_images5',
        'iconfile' => 'EXT:dl_realestate/Resources/Public/Icons/tx_dlrealestate_domain_model_realestate.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, residential_area, rent_from, rent_to, no_of_rooms, rent, furnitured, handicap_adapted, elevator, animals_allowed, other, upload_images1, upload_images2, upload_images3, upload_images4, upload_images5',
    ],
    'types' => [
