...
return [
    'ctrl' => [
        ...
        'searchFields' => 'bostadsyta,rent_from,rent_to,no_of_rooms,rent,furnitured,handicap_adapted,elevator,animals_allowed,other,upload_images1,upload_images2,upload_images3,upload_images4,upload_images5',
        'iconfile' => 'EXT:dl_realestate/Resources/Public/Icons/tx_dlrealestate_domain_model_realestate.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bostadsyta, rent_from, rent_to, no_of_rooms, rent, furnitured, handicap_adapted, elevator, animals_allowed, other, upload_images1, upload_images2, upload_images3, upload_images4, upload_images5',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, bostadsyta, rent_from, rent_to, no_of_rooms, rent, furnitured, handicap_adapted, elevator, animals_allowed, other, upload_images1, upload_images2, upload_images3, upload_images4, upload_images5, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'bostadsyta' => [
            'exclude' => true,
            'label' => 'LLL:EXT:dl_realestate/Resources/Private/Language/locallang_db.xlf:tx_dlrealestate_domain_model_realestate.bostadsyta',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
