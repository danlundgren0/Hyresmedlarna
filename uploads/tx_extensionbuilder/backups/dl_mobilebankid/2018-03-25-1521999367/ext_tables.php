...
call_user_func(
    function()
    {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue($pluginSignature, 'FILE:EXT:dl_mobilebankid/Configuration/FlexForms/flexform_mobilebankid.xml');
