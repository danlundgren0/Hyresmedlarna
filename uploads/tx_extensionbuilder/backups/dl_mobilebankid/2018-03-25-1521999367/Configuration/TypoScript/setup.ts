...
plugin.tx_dlmobilebankid_mobilebankid.settings {
    ...
    tenantGroupuid = {$plugin.tx_dlmobilebankid_mobilebankid.settings.tenantLoginPid}
    landlordGroupuid = {$plugin.tx_dlmobilebankid_mobilebankid.settings.landlordLoginPid}
}
