...
plugin.tx_dlmobilebankid_mobilebankid.settings {
    ...
    uservisibledata = 
    # cat=plugin.tx_dlmobilebankid_mobilebankid/e; type=string; label=commaseparated list if uids    
    feusergroupsuid = 
    # cat=plugin.tx_dlmobilebankid_mobilebankid/f; type=string; label=feuserlandingpage
    feuserlandingpage = 
}