...
$tmp_dl_mobilebankid_columns = [
    ...
    'bank_id_name' => [
        'exclude' => true,
        'label' => 'LLL:EXT:dl_mobilebankid/Resources/Private/Language/locallang_db.xlf:tx_dlmobilebankid_domain_model_customfrontenduser.bank_id_name',
        'config' => [
            'type' => 'input',
            'size' => 30,
            'eval' => 'trim'
...
$GLOBALS['TCA']['fe_users']['types']['Tx_DlMobilebankid_CustomFrontendUser']['showitem'] .= 'personal_number, bank_id_name';
