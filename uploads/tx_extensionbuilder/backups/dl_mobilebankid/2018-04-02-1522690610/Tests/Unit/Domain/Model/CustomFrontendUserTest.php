...
class CustomFrontendUserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getBankIdNameReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getBankIdName()
        );
    }
     ...
     * @test
     */
    public function setBankIdNameForStringSetsBankIdName()
    {
        $this->subject->setBankIdName('Conceived at T3CON10');
